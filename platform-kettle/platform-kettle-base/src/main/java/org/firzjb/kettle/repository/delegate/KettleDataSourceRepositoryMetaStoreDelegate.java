...
package org.firzjb.kettle.repository.delegate;
...
import org.firzjb.kettle.repository.delegate.metastore.KDBRMetaStoreAttribute;
import org.firzjb.kettle.repository.delegate.metastore.KDBRMetaStoreElement;
import org.firzjb.kettle.repository.delegate.metastore.KDBRMetaStoreElementType;
import org.firzjb.kettle.repository.KettleDataSourceRepository;
...
public class KettleDataSourceRepositoryMetaStoreDelegate extends KettleDataSourceRepositoryBaseDelegate {

  public KettleDataSourceRepositoryMetaStoreDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
  ...
  public ObjectId insertNamespace( String namespace ) throws KettleException {
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_NAMESPACE, table);
  ...
  public ObjectId insertElementType( KDBRMetaStoreElementType type ) throws KettleException {
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_ELEMENT_TYPE, table);
  ...
  public ObjectId insertElement( IMetaStoreElementType elementType, IMetaStoreElement element ) throws MetaStoreException {
    try {
      ...
      repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_ELEMENT, table);
  ...
  private void insertAttributes( List<IMetaStoreAttribute> children, LongObjectId elementId,
    ...
    for ( IMetaStoreAttribute child : children ) {
      ...
      repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_ELEMENT_ATTRIBUTE, table);
