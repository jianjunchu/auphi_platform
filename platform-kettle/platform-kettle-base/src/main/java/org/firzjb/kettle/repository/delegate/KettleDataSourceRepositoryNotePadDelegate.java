...
public class KettleDataSourceRepositoryNotePadDelegate extends KettleDataSourceRepositoryBaseDelegate {
  // private static Class<?> PKG = NotePadMeta.class; // for i18n purposes, needed by Translator2!!

  public KettleDataSourceRepositoryNotePadDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
  ...
  public synchronized ObjectId insertNote( String note, long gui_location_x, long gui_location_y,
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_NOTE, table);
