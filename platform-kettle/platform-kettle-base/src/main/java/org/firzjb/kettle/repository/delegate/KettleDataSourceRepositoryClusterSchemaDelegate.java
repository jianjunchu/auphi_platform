...
public class KettleDataSourceRepositoryClusterSchemaDelegate extends KettleDataSourceRepositoryBaseDelegate {

  // private static Class<?> PKG = ClusterSchema.class; // for i18n purposes, needed by Translator2!!

  public KettleDataSourceRepositoryClusterSchemaDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
  ...
  private synchronized ObjectId insertCluster( ClusterSchema clusterSchema ) throws KettleException {
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_CLUSTER, table);
