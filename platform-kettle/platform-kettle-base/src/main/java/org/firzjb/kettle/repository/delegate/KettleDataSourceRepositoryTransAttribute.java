...
public class KettleDataSourceRepositoryTransAttribute implements RepositoryAttributeInterface {

  private KettleDataSourceRepositoryConnectionDelegate connectionDelegate;
  private ObjectId transObjectId;

  public KettleDataSourceRepositoryTransAttribute( KettleDataSourceRepositoryConnectionDelegate connectionDelegate, ObjectId transObjectId ) {
