...
public class KettleDataSourceRepositoryStepDelegate extends KettleDataSourceRepositoryBaseDelegate {
  ...
  public KettleDataSourceRepositoryStepDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
    ...
    try {
      ...
      if ( r != null ) {
        ...
        if ( stepMeta.getStepMetaInterface() != null ) {
          ...
          readRepCompatibleStepMeta(stepMeta.getStepMetaInterface(), stepMeta.getObjectId(), databases );
  ...
  private void readRepCompatibleStepMeta( StepMetaInterface stepMetaInterface, ObjectId objectId, List<DatabaseMeta> databases ) throws KettleException {
  ...
  public void saveStepMeta( StepMeta stepMeta, ObjectId transformationId ) throws KettleException {
    try {
      ...
      compatibleSaveRep( stepMeta.getStepMetaInterface(), transformationId, stepMeta.getObjectId() );
  ...
  @SuppressWarnings( "deprecation" )
  private void compatibleSaveRep( StepMetaInterface stepMetaInterface, ObjectId id_transformation, ObjectId objectId ) throws KettleException {
