...
public class KettleDataSourceRepositoryUserDelegate extends KettleDataSourceRepositoryBaseDelegate {

  private static Class<?> PKG = UserInfo.class; // for i18n purposes, needed by Translator2!!

  public KettleDataSourceRepositoryUserDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
  ...
  public void saveUserInfo( IUser userInfo ) throws KettleException {
    try {
      ...
      if ( userInfo.getObjectId() == null ) {
        ...
        repository.getDatabase().insertTableRow( "R_USER", fillTableRow( userInfo ) );
      } else {
