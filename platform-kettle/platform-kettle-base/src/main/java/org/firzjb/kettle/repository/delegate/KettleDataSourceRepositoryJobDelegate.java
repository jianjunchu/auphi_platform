...
public class KettleDataSourceRepositoryJobDelegate extends KettleDataSourceRepositoryBaseDelegate {
  ...
  public KettleDataSourceRepositoryJobDelegate( KettleDataSourceRepository repository ) {
    super( repository );
  }
      ...
      try {
        ...
        if ( jobMeta.getObjectId() != null ) {
          ...
          RepositoryAttributeInterface attributeInterface =
            new KettleDataSourceRepositoryJobAttribute( repository.connectionDelegate, jobMeta.getObjectId() );
  ...
  private synchronized void insertJob( JobMeta jobMeta ) throws KettleException {
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_JOB, table);
...
//    repository.connectionDelegate.getDatabase().closeInsert();
    ...
    repository.getDatabase().insertTableRow(KettleDatabaseRepository.TABLE_R_JOB_HOP, table);
