...
public class UserUtils {
	...
	public static String decodePath(CurrentUserResponse user, String path) {
		String userDir = com.aofei.base.common.Const.getUserDir(user.getOrganizerId());
	...
	public static void main(String[] args) {
		String str = "D:\\data\\1068523747487088641\\1111\\2222";
		String str2 = "D:\\data\\1068523747487088641";
