/*
 ...
 Source Schema         : etl_platform_cloud_server

 Target Server Type    : MySQL
 Target Server Version : 50729
 File Encoding         : 65001

 Date: 30/03/2021 13:36:59
*/
...
CREATE TABLE `LOG_JOB_DEPENDENCIES` (
  ...
  `JOB_NAME` varchar(200) DEFAULT NULL COMMENT '事件调度名称',
  `JOB_GROUP` varchar(200) DEFAULT NULL COMMENT '事件调度分组',
  `EXECUTE_JOB_NAME` varchar(200) DEFAULT NULL COMMENT '执行的调度名称',
  `EXECUTE_JOB_GROUP` varchar(200) DEFAULT NULL COMMENT '执行的调度分组',
  `STARTDATE` datetime DEFAULT NULL,
  `ENDDATE` datetime DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_GROUP` VALUES ('1372168543064043522', 1, 0, '默认分组', '系统自动创建默认分组', 'fwadmin', 'fwadmin', '2021-03-17 20:50:49', '2021-03-17 20:50:49', 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `R_DATABASE` VALUES (1, 'db_query_statistics', 6, 1, '10.211.55.5', 'ORCL', 1521, 'SYS AS SYSDBA', 'Encrypted 2be98afc86aa7f2e4cb79ff228dc6fa8c', NULL, NULL, NULL, 1, 'fwadmin', 'fwadmin', '2021-03-20 23:06:55', '2021-03-29 18:02:00');
COMMIT;
...
INSERT INTO `R_DATABASE_ATTRIBUTE` VALUES (6, 1, 'PORT_NUMBER', '1521');
...
-- ----------------------------
BEGIN;
INSERT INTO `R_REPOSITORY_LOG` VALUES (1, '5.0', '2021-03-17 20:49:22', 'admin', '创建作业');
INSERT INTO `R_REPOSITORY_LOG` VALUES (2, '5.0', '2021-03-17 20:49:22', 'admin', 'save job \'dataExtract_job\'');
INSERT INTO `R_REPOSITORY_LOG` VALUES (3, '5.0', '2021-03-20 23:06:55', 'admin', 'add database');
INSERT INTO `R_REPOSITORY_LOG` VALUES (4, '5.0', '2021-03-29 18:02:00', 'admin', 'add database');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `R_USER` VALUES (1, 'admin', '28cd8fcaa18d5c68ff84e9064ceb58390', 'Administrator', 'User manager', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_MENU` VALUES (10000000, 0, '系统监控', 'home', 'home', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (11000000, 10000000, '数据装载情况', 'sdata_loading_statistical', 'sdata_loading_statistical', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (12000000, 10000000, '任务运行情况', 'dashboard', 'dashboard', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (30000000, 0, '作业管理', 'designer', 'designer', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (50000000, 0, '任务管理', 'schedule', 'schedule', 0, 'table', 0, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (53000000, 50000000, '任务分组', 'schedule-group', 'schedule-group', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (54000000, 50000000, '任务调度', 'schedule-cycle', 'schedule-cycle', 1, 'NULL', 3, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (55000000, 50000000, '事件调度', 'schedule-depend', 'schedule-depend', 1, 'NULL', 3, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (56000000, 50000000, '调度计划', 'schedule-plan', 'schedule-plan', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (57000000, 50000000, '任务运行情况', 'schedule-monitor', 'schedule-monitor', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (58000000, 50000000, '事件调度日志', 'depend-monitor', 'depend-monitor', 0, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (70000000, 0, '数据源管理', 'data-source', 'data-source', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (71000000, 70000000, '数据库管理', 'data-source-database', 'data-source-database', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (72000000, 70000000, '本地文件管理', 'data-source-disk', 'data-source-disk', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (90000000, 0, '质量管理', 'data-quality', 'data-quality', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (91000000, 90000000, '质量管理分组', 'data-quality-rule-group', 'data-quality-rule-group', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (92000000, 90000000, '质量规则管理', 'data-quality-rule', 'data-quality-rule', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (93000000, 90000000, '质量分析', 'data-quality-overview', 'data-quality-overview', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (94000000, 90000000, '数据稽核', 'data-quality-compare', 'data-quality-compare', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (110000000, 0, '查询统计', 'query-statistics', 'query-statistics', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (111000000, 110000000, '数据上传频率', 'backup-frequency-statistics', 'backup-frequency-statistics', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (112000000, 110000000, '数据装载记录', 'backup-record-query', 'backup-record-query', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (113000000, 110000000, '文件接收记录', 'query-statistics-file-recv', 'query-statistics-file-recv', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (114000000, 110000000, '详细记录查询', 'certificate-record', 'certificate-record', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (115000000, 110000000, '错误数据查询', 'serror-data-query', 'serror-data-query', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (130000000, 0, '系统管理', 'sys-manage', 'sys-manage', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (131000000, 130000000, '用户管理', 'sys-user-list', 'sys-user-list', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (132000000, 130000000, '组织管理', 'sys-organizer-list', 'sys-organizer-list', 1, 'NULL', NULL, 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (133000000, 130000000, '角色管理', 'sys-role-list', 'sys-role-list', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (134000000, 130000000, '部门管理', 'sys-unit-list', 'sys-unit-list', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (136000000, 130000000, '权限配置', 'sys-user-role', 'sys-user-role', 2, 'NULL', NULL, NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (150000000, 0, '审计日志', 'sys-monitor', 'sys-monitor', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (151000000, 150000000, '登录日志', 'login-log', 'login-log', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (152000000, 150000000, '调度日志', 'schedule-log', 'schedule-log', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (153000000, 150000000, '操作日志', 'menu-log', 'menu-log', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (170000000, 0, '数据生命周期管理', 'data-lifecycle-manage', 'data-lifecycle-manage', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (171000000, 170000000, '数据状态标识', 'data-status-log', 'data-status-log', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (172000000, 170000000, '数据变更轨迹', 'data-change-trajectory', 'data-change-trajectory', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (173000000, 170000000, '数据变更流程', 'data-change-process', 'data-change-process', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (230000000, 0, '元数据管理', 'metadata-manage', 'metadata-manage', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (250000000, 0, '资源目录管理', 'dir-manage', 'dir-manage', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (270000000, 0, '数据生命周期', 'data_life_cycle', 'data_life_cycle', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
COMMIT;
...
CREATE TABLE `SYS_ORGANIZER` (
  ...
  `ORGANIZER_SHORT_NAME` varchar(100) DEFAULT NULL COMMENT '简称',
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COMMENT='组织信息';

-- ----------------------------
-- Records of SYS_ORGANIZER
-- ----------------------------
BEGIN;
INSERT INTO `SYS_ORGANIZER` VALUES (1, 0, '', '制证数据实时汇聚系统', '制证数据实时汇聚系统', NULL, '', '', NULL, '', NULL, 1, 1, 116.453002, 39.927885, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (2, 1, '110000000000', '北京市公安局人口管理总队', '北京', NULL, '', '', NULL, '', NULL, 1, 1, 116.453002, 39.927885, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (3, 1, '120000000000', '天津市局制证中心', '天津', NULL, '', '', NULL, '', NULL, 1, 1, 117.299278, 39.015314, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (4, 1, '500000000000', '重庆市局制证中心', '重庆', NULL, '', '', NULL, '', NULL, 1, 1, 106.628846, 29.536549, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (5, 1, '130000000000', '河北省公安厅制证中心', '河北', NULL, '', '', NULL, '', NULL, 1, 1, 115.526948, 38.719444, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (6, 1, '130100000000', '石家庄制证所', '石家庄', NULL, '', '', NULL, '', NULL, 1, 1, 114.570288, 37.995114, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (7, 1, '140100000000', '山西省公安厅制证中心', '山西', NULL, '', '', NULL, '', NULL, 1, 1, 110.854034, 37.527717, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (8, 1, '640000000000', '宁夏省公安厅制证中心', '宁夏', NULL, '', '', NULL, '', NULL, 1, 1, 106.144326, 37.292903, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (9, 1, '310000000000', '上海市公安厅制证中心', '上海', NULL, '', '', NULL, '', NULL, 1, 1, 121.671645, 31.186640, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (10, 1, '330000000000', '浙江省公安厅制证中心', '浙江', NULL, '', '', NULL, '', NULL, 1, 1, 120.052683, 29.656012, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (11, 1, '360000000000', '江西省公安厅制证中心', '江西', NULL, '', '', NULL, '', NULL, 1, 1, 115.858099, 28.362211, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (12, 1, '610000000000', '陕西省公安厅治安局五处', '陕西', NULL, '', '', NULL, '', NULL, 1, 1, 108.867126, 34.600562, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (13, 1, '440000000000', '广东省公安厅制证中心', '广东', NULL, '', '', NULL, '', NULL, 1, 1, 113.245683, 24.453390, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (14, 1, '440100000000', '广州市局制证所', '广州', NULL, '', '', NULL, '', NULL, 1, 1, 113.282477, 23.098878, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (15, 1, '140300000000', '深圳市局制证所', '深圳', NULL, '', '', NULL, '', NULL, 1, 1, 114.331123, 22.792167, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (16, 1, '460000000000', '海南省公安厅制证中心', '海南', NULL, '', '', NULL, '', NULL, 1, 1, 109.621415, 19.094227, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (17, 1, '530000000000', '云南省公安厅制证中心', '云南', NULL, '', '', NULL, '', NULL, 1, 1, 101.342632, 24.588050, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (18, 1, '340000000000', '安徽省公安厅制证中心', '安徽', NULL, '', '', NULL, '', NULL, 1, 1, 117.017129, 32.068191, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (19, 1, '510000000000', '四川省公安厅制证中心', '四川', NULL, '', '', NULL, '', NULL, 1, 1, 101.416221, 29.559547, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (20, 1, '510100000000', '成都市局制证所', '成都', NULL, '', '', NULL, '', NULL, 1, 1, 104.028637, 30.551828, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (21, 1, '230000000000', '黑龙江省公安厅制证中心', '黑龙江', NULL, '', '', NULL, '', NULL, 1, 1, 128.018712, 47.084866, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (22, 1, '450000000000', '广西省公安厅制证中心', '广西', NULL, '', '', NULL, '', NULL, 1, 1, 109.032702, 23.744050, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (23, 1, '150000000000', '内蒙古公安厅制证中心', '内蒙', NULL, '', '', NULL, '', NULL, 1, 1, 116.906745, 44.300759, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (24, 1, '650000000000', '新疆公安厅制证中心', '新疆', NULL, '', '', NULL, '', NULL, 1, 1, 85.631340, 41.266119, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (25, 1, '630000000000', '青海公安厅制证中心', '青海', NULL, '', '', NULL, '', NULL, 1, 1, 96.007416, 35.958305, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (26, 1, '210000000000', '辽宁省公安厅制证中心', '辽宁', NULL, '', '', NULL, '', NULL, 1, 1, 122.867469, 41.708808, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (27, 1, '540000000000', '西藏公安厅制证中心', '西藏', NULL, '', '', NULL, '', NULL, 1, 1, 87.544659, 31.470915, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (28, 1, '420000000000', '湖北省公安厅制证中心', '湖北', NULL, '', '', NULL, '', NULL, 1, 1, 110.798842, 32.005503, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (29, 1, '420100000000', '武汉市局制证所', '武汉', NULL, '', '', NULL, '', NULL, 1, 1, 114.367918, 30.647321, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (30, 1, '370000000000', '山东省公安厅制证中心', '山东', NULL, '', '', NULL, '', NULL, 1, 1, 121.046137, 37.175218, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (31, 1, '370100000000', '济南市制证所', '济南', NULL, '', '', NULL, '', NULL, 1, 1, 116.888348, 37.219372, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (32, 1, '370200000000', '青岛市制证所', '青岛', NULL, '', '', NULL, '', NULL, 1, 1, 117.532253, 35.417966, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (33, 1, '220000000000', '吉林省公安厅制证中心', '吉林', NULL, '', '', NULL, '', NULL, 1, 1, 126.786093, 43.542778, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (34, 1, '320000000000', '江苏省公安厅制证中心', '江苏', NULL, '', '', NULL, '', NULL, 1, 1, 119.427175, 33.698102, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (35, 1, '520000000000', '贵州省公安厅制证中心', '贵州', NULL, '', '', NULL, '', NULL, 1, 1, 106.917013, 26.870923, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (36, 1, '350000000000', '福建省公安厅制证中心', '福建', NULL, '', '', NULL, '', NULL, 1, 1, 118.102569, 26.076144, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (37, 1, '410000000000', '河南省公安厅制证中心', '河南', NULL, '', '', NULL, '', NULL, 1, 1, 113.319272, 34.066378, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (38, 1, '430000000000', '湖南省公安厅制证中心', '湖南', NULL, '', '', NULL, '', NULL, 1, 1, 112.325818, 26.308527, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (39, 1, '430100000000', '长沙市制证所', '长沙', NULL, '', '', NULL, '', NULL, 1, 1, 112.988121, 28.248229, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (40, 1, '620000000000', '甘肃省公安厅制证中心', '甘肃', NULL, '', '', NULL, '', NULL, 1, 1, 104.598953, 34.858781, NULL, NULL, NULL, NULL, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_ROLE` VALUES (1, '管理员', '服务端用户', 1, NULL, 1, 'admin', 'admin', '2020-11-09 16:19:50', '2020-11-10 10:39:39', 0);
INSERT INTO `SYS_ROLE` VALUES (2, '数据管理用户', '服务端用户', 1, NULL, 1, 'admin', 'admin', '2020-11-09 21:16:49', '2020-11-10 18:17:16', 0);
INSERT INTO `SYS_ROLE` VALUES (3, '查询用户', '服务端用户', 1, NULL, 1, 'admin', 'admin', '2020-11-10 18:17:34', '2021-02-25 16:47:13', 0);
INSERT INTO `SYS_ROLE` VALUES (4, '数据治理用户', '服务端用户', 1, NULL, 1, 'admin', 'admin', '2020-11-10 18:17:34', '2021-02-25 16:47:13', 0);
INSERT INTO `SYS_ROLE` VALUES (5, '制证中心管理员', '制证中心用户', 1, NULL, 1, 'admin', 'admin', '2020-11-10 18:17:34', '2021-02-25 16:47:13', 0);
INSERT INTO `SYS_ROLE` VALUES (6, '制证中心查询用户', '制证中心用户', 1, NULL, 1, 'admin', 'admin', '2020-11-10 18:17:34', '2021-02-25 16:47:13', 0);
COMMIT;
...
INSERT INTO `SYS_ROLE_MENU` VALUES (2, 14000);
INSERT INTO `SYS_ROLE_MENU` VALUES (2, 14001);
INSERT INTO `SYS_ROLE_MENU` VALUES (2, 15000);
INSERT INTO `SYS_ROLE_MENU` VALUES (2, 171000);
INSERT INTO `SYS_ROLE_MENU` VALUES (3, 81000);
INSERT INTO `SYS_ROLE_MENU` VALUES (3, 82000);
INSERT INTO `SYS_ROLE_MENU` VALUES (3, 83000);
INSERT INTO `SYS_ROLE_MENU` VALUES (3, 84000);
INSERT INTO `SYS_ROLE_MENU` VALUES (3, 85000);
INSERT INTO `SYS_ROLE_MENU` VALUES (5, 86000);
INSERT INTO `SYS_ROLE_MENU` VALUES (5, 87000);
INSERT INTO `SYS_ROLE_MENU` VALUES (5, 141000);
INSERT INTO `SYS_ROLE_MENU` VALUES (6, 86000);
INSERT INTO `SYS_ROLE_MENU` VALUES (6, 87000);
COMMIT;
...
CREATE TABLE `SYS_USER` (
  ...
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '最后时间更新',
  `DEL_FLAG` tinyint(4) DEFAULT '0' COMMENT '是否删除  1：已删除  0：正常',
  `C_FIELD1` varchar(255) DEFAULT NULL COMMENT '预留字段1',
  `C_FIELD2` varchar(255) DEFAULT NULL COMMENT '预留字段2',
  `C_FIELD3` varchar(255) DEFAULT NULL COMMENT '预留字段3',
  `C_FIELD4` varchar(255) DEFAULT NULL COMMENT '预留字段4',
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_USER` VALUES (1, 'fwadmin', 'f99fd6f4f0d1ca54d4', '管理员', 'firzjb@firzjb.com', '86', '13311111111', '服务端用户', 1, 1, 0, 0, '2021-03-29 17:59:54', '0:0:0:0:0:0:0:1', 1073741824, NULL, 'admin', '2020-10-28 16:47:53', '2020-10-28 10:32:23', 0,'f9bc34237759f33874262a50a1325b181206efa9','ABC','96e79218965eb72c92a549dd5a330112','');
INSERT INTO `SYS_USER` VALUES (2, 'sjadmin', '200ceb26807d6bf', '数据管理', 'firzjb@firzjb.com', '86', '13311111111', '服务端用户', 0, 1, 0, 0, '2021-03-01 16:55:17', '119.56.16.140', 1073741824, NULL, NULL, '2020-10-28 16:47:56', '2020-10-28 16:47:41', 0,'','ABC','96e79218965eb72c92a549dd5a330112','');
INSERT INTO `SYS_USER` VALUES (3, 'cxuser', '6bf99fd6f4f0d1c', '查询用户', 'firzjb@firzjb.com', '86', '13311111111', '服务端用户', 0, 1, 0, 0, '2021-02-23 14:17:53', '123.112.152.111', 1073741824, 'admin', 'admin', '2020-11-11 08:15:27', '2020-11-11 08:15:27', 0,'','ABC','96e79218965eb72c92a549dd5a330112','');
INSERT INTO `SYS_USER` VALUES (4, 'sjzluser', 'ceb26807d6bf99', '数据治理', 'firzjb@firzjb.com', '86', '13311111111', '服务端用户', 0, 1, 0, 0, '2021-02-26 15:26:03', '114.242.249.133', 1073741824, 'admin', 'admin', '2020-11-11 08:17:16', '2020-11-11 08:17:16', 0,'','ABC','96e79218965eb72c92a549dd5a330112','');
INSERT INTO `SYS_USER` VALUES (5, 'bjzzadmin', '7d6bf99fd6f4f0d', '制证中心管理员', 'firzjb@firzjb.com', '86', '13311111111', '制证中心用户', 0, 1, 2, 0, '2021-03-22 21:16:46', '0:0:0:0:0:0:0:1', 1073741824, 'admin', 'admin', '2020-11-11 08:17:16', '2020-11-11 08:17:16', 0,'','ABC','96e79218965eb72c92a549dd5a330112','');
INSERT INTO `SYS_USER` VALUES (6, 'bjzzuser', '27d6bf99fd654d4', '制证中心用户', 'firzjb@firzjb.com', '86', '13311111111', '制证中心用户', 0, 1, 2, 0, '2021-02-26 15:26:03', '114.242.249.133', 1073741824, 'admin', 'admin', '2020-11-11 08:17:16', '2020-11-11 08:17:16', 0,'','ABC','96e79218965eb72c92a549dd5a330112','');
COMMIT;
...
DROP USER IF EXISTS ETLWEB_DBA;
CREATE USER 'ETLWEB_DBA'@'%' IDENTIFIED BY 'ETLWEB_DBA';
GRANT ALL PRIVILEGES ON `MDM_MODEL_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `LOG_TRANS_STEP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASOURCE_INTERFACE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_CLUSTER_SLAVE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_CONFIG` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_CHECK_RESULT` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_PLATFORM_LOG` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_SCHEDULER_STATE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_CLUSTER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_COMPARE_SQL_FIELD` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_PAUSED_TRIGGER_GRPS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_USER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_LOCKS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_REPOSITORY_DATABASE_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOB_NOTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_JOB_LOG` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASOURCE_INTERFACE_RESPONSE_MAPPING` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_NAMESPACE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_USER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_JOB_ORGANIZER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_SIMPLE_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOBENTRY_COPY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `HA_CLUSTER_SLAVE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOBENTRY_TYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `HA_SLAVE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_VALUE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_HOP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOB_HOP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `MDM_MODEL` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_CLUSTER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `PROFILE_TABLE_RESULT` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_SMS_COUNTRY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `PROFILE_TABLE_GROUP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ROLE_MENU` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DATABASE_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_STEP_CONDITION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_NOTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_CONDITION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_REPOSITORY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ROLE_OPERATION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_VERSION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANSFORMATION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_PARTITION_SCHEMA` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_STEP_TYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_INTERFACE_FIELD` TO 'ETLWEB_DBA'@'%';
GRANT SELECT ON `R_USER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_RECEIVE_INTERFACE_FIELDS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DIRECTORY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ROLE_RESOURCE_TYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_LOCK` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `LOG_JOB` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_ELEMENT_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_SIMPROP_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `LOG_JOB_DEPENDENCIES` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `MDM_TABLE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `LOG_JOB_STEP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_REPOSITORY_DATABASE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_CRON_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_CHECK_RESULT_ERR` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOBENTRY_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_JOB_DEPENDENCIES` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASOURCE_HADOOP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_FIRED_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_BLOB_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_MONITOR` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_STEP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `PROFILE_TABLE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `HA_SLAVE_STATUS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_GROUP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_REPOSITORY_LOG` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ORGANIZER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_PARTITION_SCHEMA` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `LOG_TRANS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DATABASE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_RULE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `MDM_REL_CONS_ATTR` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASOURCE_INTERFACE_PARAMETER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_LOG` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_INTERFACE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_STEP_DATABASE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_AUTH` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOBENTRY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_RECEIVE_INTERFACE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_JOB_DETAILS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ROLE_PRIVILEDGE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `MDM_DATA_CLEAN` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DATABASE_TYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_MENU` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_COMPARE_SQL` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_NOTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_COMPARE_SQL_RESULT` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_ELEMENT` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASOURCE_FTP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_RULE_GROUP` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `HA_CLUSTER` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_PROVINCE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATASERVICE_MONITOR_STEP_INFO` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOB` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `PROFILE_TABLE_COLUMN` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DEPENDENCY` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOBENTRY_DATABASE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_PARTITION` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_TRIGGERS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_STEP_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_TRANS_SLAVE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_USER_ROLE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_SLAVE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_ELEMENT_TYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `MDM_MODEL_CONSTAINT` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_DATABASE_CONTYPE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOB_ATTRIBUTE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `SYS_ROLE` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_LOGLEVEL` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `QRTZ_CALENDARS` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `DATA_QUALITY_RULE_ATTR` TO 'ETLWEB_DBA'@'%';
GRANT ALL PRIVILEGES ON `R_JOB_LOCK` TO 'ETLWEB_DBA'@'%';
