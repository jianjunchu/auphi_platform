...
) DEFAULT CHARSET=utf8mb4 COMMENT='服务接口授权';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据接口管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据发布访问用户\n';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='FTP管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='HADOOP管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据接口参数管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据接口返回值字段映射';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据质量规则分组';
...
CREATE TABLE `MDM_DATA_CLEAN` (
  ...
  `DEL_FLAG` tinyint(4) DEFAULT '0' COMMENT '是否删除  1：已删除  0：正常',
  PRIMARY KEY (`ID`) USING BTREE
) DEFAULT CHARSET=utf8mb4 COMMENT='数据映射';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='主数据模型';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='主数据模型属性';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='主数据表';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='调度分组';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='依赖调度关系表';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='调度用户表';
...
CREATE TABLE `SYS_CONFIG` (
  ...
  `CREATE_USER` varchar(64) CHARACTER SET utf8  DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(64) CHARACTER SET utf8  DEFAULT NULL COMMENT '最后修改用户',
  `CREATE_TIME` datetime DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime DEFAULT NULL COMMENT '最后时间更新',
  `DEL_FLAG` tinyint(4) DEFAULT '0' COMMENT '是否删除  1：已删除  0：正常',
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_ORGANIZER` VALUES (1, 0, NULL, '北京傲飞商智软件有限公司', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, 0,0,NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_ORGANIZER` VALUES (2, 1, '110000000000', '默认单位', NULL, '', '', NULL, '', NULL, 1, 1, 0,0,NULL, NULL, NULL, NULL, 0);
COMMIT;
...
) DEFAULT CHARSET=utf8mb4 COMMENT='资源库管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='资源库';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='资源库链接属性';
...
INSERT INTO `SYS_ROLE`  VALUES (1, '管理员', '系统保留不可修改', 0, NULL, 1, 'admin', 'admin', '2020-11-09 16:19:50', '2020-11-10 10:39:39', 0);
COMMIT;
...
) DEFAULT CHARSET=utf8mb4 COMMENT='设计器操作';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='设计器权限';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='设计器权限类型';
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_USER`  VALUES (1, 'admin', '96e79218965eb72c92a549dd5a330112', 'admin', '', NULL, '', '管理员', 1, 1, 0, 0, '2021-02-25 16:46:45', '183.30.59.243', 1073741824, NULL, 'doetl', '2020-10-28 16:47:53', '2020-10-28 10:32:23', 0);
INSERT INTO `SYS_USER`  VALUES (1077874329775038466, 'doetl', '96e79218965eb72c92a549dd5a330112', 'doetl', NULL, NULL, '', NULL, 0, 1, 2, 0,'2021-02-05 20:56:53', '0:0:0:0:0:0:0:1', 1073741824, NULL, NULL, '2020-10-28 16:47:56', '2020-10-28 16:47:41', 0);
COMMIT;
