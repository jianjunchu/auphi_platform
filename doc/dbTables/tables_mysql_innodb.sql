...
CREATE TABLE `LOG_JOB` (
  ...
  `EXECUTING_USER` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `EXCUTOR_TYPE` tinyint(4) DEFAULT NULL COMMENT '1:表示本地，2表示远程，3表示集群',
  `JOB_LOG` longtext COLLATE utf8_unicode_ci,
...
CREATE TABLE `LOG_JOB_STEP` (
  ...
  `SETP_LOG` longtext COLLATE utf8_unicode_ci,
...
INSERT INTO `SYS_CONFIG` VALUES (8, 'PLATFORM_SYS', 'login_title', '制证数据实时汇聚系统', NULL, 'doetl', 'doetl', '2021-02-05 16:17:21', '2021-02-05 16:17:21', 0);
...
CREATE TABLE `SYS_ORGANIZER` (
     ...
     `ORGANIZER_CODE` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '编号',
...
-- ----------------------------
BEGIN;
INSERT INTO SYS_ORGANIZER  VALUES (1, 0, NULL, '制证数据实时汇聚系统', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_USER`  VALUES (1, 'admin', '96e79218965eb72c92a549dd5a330112', 'admin', '381906259@qq.com', NULL, '13614019065', '管理员', 1, 1, 0, 0, '2021-02-25 16:46:45', '183.30.59.243', 1073741824, NULL, 'doetl', '2020-10-28 16:47:53', '2020-10-28 10:32:23', 0);
INSERT INTO `SYS_USER`  VALUES (1077874329775038466, 'doetl', '96e79218965eb72c92a549dd5a330112', 'doetl', NULL, '86', '13380348067', NULL, 0, 1, 0, 0, '2021-03-01 16:55:17', '119.56.16.140', 1073741824, NULL, NULL, '2020-10-28 16:47:56', '2020-10-28 16:47:41', 0);
INSERT INTO `SYS_USER`  VALUES (1326317578678726658, 'doetl1', '96e79218965eb72c92a549dd5a330112', '服务', '123456@qq.com', NULL, '13311111111', '服务端用户', 0, 1, 0, 0, '2021-02-23 14:17:53', '123.112.152.111', 1073741824, 'doetl', 'doetl', '2020-11-11 08:15:27', '2020-11-11 08:15:27', 0);
INSERT INTO `SYS_USER`  VALUES (1326318037690773505, 'doetl2', '96e79218965eb72c92a549dd5a330112', '制证中心', '1234567@qq.com', NULL, '13322222222', '制证中心用户', 0, 1, 0, 0, '2021-02-26 15:26:03', '114.242.249.133', 1073741824, 'doetl', 'doetl', '2020-11-11 08:17:16', '2020-11-11 08:17:16', 0);
COMMIT;
