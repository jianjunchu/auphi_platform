...
-- ----------------------------
--  Table structure for `DATASERVICE_INTERFACE_PARAMETER`
-- ----------------------------
DROP TABLE IF EXISTS `R_INTERFACE_PARAMETER`;
CREATE TABLE `R_INTERFACE_PARAMETER` (
...
CREATE TABLE `DATA_QUALITY_RULE` (
  ...
  PRIMARY KEY (`RULE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='数据质量管理-规则管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='数据质量管理-规则属性值';
