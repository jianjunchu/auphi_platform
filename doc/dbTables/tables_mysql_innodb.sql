...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='服务接口授权';
...
) DEFAULT CHARSET=utf8 COMMENT='数据接口管理';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='数据发布访问用户\n';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='FTP管理';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='HADOOP管理';
...
) DEFAULT CHARSET=utf8 COMMENT='数据接口参数管理';
...
) DEFAULT CHARSET=utf8 COMMENT='数据接口返回值字段映射';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据质量管理-规则检查结果';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据质量管理-错误字段值记录';
...
CREATE TABLE `DATA_QUALITY_RULE` (
  ...
  `DEL_FLAG` tinyint(1) DEFAULT NULL COMMENT '是否删除  1：已删除  0：正常',
  PRIMARY KEY (`RULE_ID`)
) DEFAULT CHARSET=utf8mb4 COMMENT='数据质量管理-规则管理';
...
) DEFAULT CHARSET=utf8mb4 COMMENT='数据质量管理-规则属性值';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='数据质量规则分组';
...
CREATE TABLE `LOG_JOB_DEPENDENCIES` (
  ...
  `JOB_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '事件调度名称',
  `JOB_GROUP` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '事件调度分组',
  `EXECUTE_JOB_NAME` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '执行的调度名称',
  `EXECUTE_JOB_GROUP` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '执行的调度分组',
  `STARTDATE` datetime DEFAULT NULL,
  `ENDDATE` datetime DEFAULT NULL,
...
) DEFAULT CHARSET=utf8mb4 COMMENT='事件调度日志\n';
...
CREATE TABLE `LOG_TRANS` (
  ...
  `EXECUTING_USER` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `EXCUTOR_TYPE` tinyint(4) DEFAULT NULL COMMENT '1:表示本地，2表示远程，3表示集群',
  `LOGINFO` longtext COLLATE utf8_unicode_ci,
...
CREATE TABLE `MDM_DATA_CLEAN` (
  ...
  `DEL_FLAG` tinyint(4) DEFAULT '0' COMMENT '是否删除  1：已删除  0：正常',
  PRIMARY KEY (`ID`) USING BTREE
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='数据映射';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='主数据模型';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='主数据模型属性';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='主数据表';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='调度分组';
...
CREATE TABLE `QRTZ_JOB_DEPENDENCIES` (
  ...
  `SCHED_NAME` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `JOB_NAME` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '事件调度名称',
  `JOB_GROUP` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '事件调度分组',
  `START_JOB_GROUP` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '调度分组',
  `START_JOB_NAME` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '调度名称',
  `NEXT_JOB_GROUP` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '依赖调度分组',
  `NEXT_JOB_NAME` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT '依赖调度名称',
  PRIMARY KEY (`DEPEND_ID`) USING BTREE
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='依赖调度关系表';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='调度用户表';
...
INSERT INTO `R_STEP_TYPE` VALUES (159, 'AccessInput', 'Access ??', 'Read data from a Microsoft Access file');
INSERT INTO `R_STEP_TYPE` VALUES (160, 'AccessOutput', 'Access ??', 'Stores records into an MS-Access database table.');
...
INSERT INTO `R_STEP_TYPE` VALUES (179, 'MetaInject', 'ETL metadata injection', 'ETL?????');
...
INSERT INTO `R_STEP_TYPE` VALUES (231, 'Abort', '??', 'Abort a transformation');
INSERT INTO `R_STEP_TYPE` VALUES (232, 'AnalyticQuery', '????', 'Execute analytic queries over a sorted dataset (LEAD/LAG/FIRST/LAST)');
INSERT INTO `R_STEP_TYPE` VALUES (233, 'CombinationLookup', '????/??', '??????????junk? {0} ???, ?????????.{1}junk??????????.');
INSERT INTO `R_STEP_TYPE` VALUES (234, 'AutoDoc', '??????', 'This step automatically generates documentation based on input in the form of a list of transformations and jobs');
INSERT INTO `R_STEP_TYPE` VALUES (235, 'Append', '???', 'Append 2 streams in an ordered way');
COMMIT;
...
INSERT INTO `SYS_CONFIG` VALUES (8, 'PLATFORM_SYS', 'login_title', '傲飞数据整合平台', NULL, 'doetl', 'doetl', '2021-02-05 16:17:21', '2021-02-05 16:17:21', 0);
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='菜单管理';
...
INSERT INTO `SYS_MENU` VALUES (14000, 10000, '周期调度', 'schedule-cycle', 'schedule-cycle', 1, 'NULL', 3, 0, NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `SYS_MENU` VALUES (85000, 80000, '错误数据查询', 'perror-data-query', 'perror-data-query', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (86000, 80000, '数据抽取记录查询', 'exact-data-query', 'exact-data-query', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `SYS_MENU` VALUES (300000, 0, '系统配置', 'sys-config', 'sys-config', 0, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (310000, 300000, '制证中心配置', 'config-making-center', 'config-making-center', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
INSERT INTO `SYS_MENU` VALUES (320000, 300000, '抽取参数配置', 'config-extract-param', 'config-extract-param', 1, 'NULL', NULL, 0, NULL, NULL, NULL, NULL, 0);
COMMIT;
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='组织信息';

-- ----------------------------
-- Records of SYS_ORGANIZER
-- ----------------------------
BEGIN;
INSERT INTO `SYS_ORGANIZER` VALUES (1, '北京傲飞商智软件有限公司', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, 0);
COMMIT;
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='系统日志';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='资源库管理';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='资源库';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='资源库链接属性';
...
INSERT INTO `SYS_ROLE_MENU` VALUES (1, 300000);
INSERT INTO `SYS_ROLE_MENU` VALUES (1, 310000);
INSERT INTO `SYS_ROLE_MENU` VALUES (1, 320000);
...
) DEFAULT CHARSET=utf8 COMMENT='设计器操作';
...
) DEFAULT CHARSET=utf8 COMMENT='设计器权限';
...
) DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='设计器权限类型';
...
-- ----------------------------
BEGIN;
INSERT INTO `SYS_USER` VALUES (1, 'admin', '96e79218965eb72c92a549dd5a330112', 'admin', '381906259@qq.com', NULL, '13614019065', '管理员', 1, 0, 0, '2020-11-10 23:01:52', '0:0:0:0:0:0:0:1', 1073741824, NULL, 'doetl', '2020-10-28 16:47:53', '2020-10-28 10:32:23', 0);
INSERT INTO `SYS_USER` VALUES (1077874329775038466, 'doetl', '96e79218965eb72c92a549dd5a330112', 'doetl', NULL, NULL, '13380348067', NULL, 0, 1, 0, '2021-02-05 20:56:53', '0:0:0:0:0:0:0:1', 1073741824, NULL, NULL, '2020-10-28 16:47:56', '2020-10-28 16:47:41', 0);
COMMIT;
