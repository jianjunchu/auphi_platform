package com.auphi.designer.job.steps;

import com.auphi.designer.core.PropsUI;
import com.auphi.designer.job.step.AbstractJobEntry;
...
public class JobEntryCheckDbConnections extends AbstractJobEntry {
	...
	public void decode(JobEntryInterface jobEntry, mxCell cell, List<DatabaseMeta> databases, IMetaStore metaStore) throws Exception {
		...
		for(int i=0; i<jsonArray.size(); i++) {
			...
			jobEntryCheckDbConnections.getConnections()[1] = DatabaseMeta.findDatabase(databases, jsonObject.optString("name"));
