/**
 * Created by lilongyun on 16/7/10.
 */
ExcelInputDialog = Ext.extend(KettleTabDialog, {
    width: 700,
    height: 600,
    showPreview:true,
    title: BaseMessages.getString(PKG, "ExcelInputDialog.DialogTitle"),
    initComponent: function() {
        var me = this;
        var cell = getActiveGraph().getGraph().getSelectionCell();

        var wSpreadSheetType = new Ext.form.ComboBox({
            store: Ext.StoreMgr.get('spreadSheetTypeStore'),
            displayField:'name',
            valueField:'name',
            typeAhead: true,
            mode: 'local',
...
//						wFileErrorMessageField.setDisabled(false);
        ...
        this.tabItems = [{
            ...
            items: [{
                ...
                fieldLabel: '文件名称',
                anchor: '-10',
                items: [wSpreadSheetType,wFilename, waddfilebutton,wfindbutton]
