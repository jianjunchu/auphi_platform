...
<head>
    ...
    <title><%=Messages.getString("Default.Jsp.Title") %>
    </title>
                ...
                items: [
                    {
                        ...
                        root: {
                            ...
                            children: [
                                {
                                    id: "01",
                                    iconCls: 'icon_fuwuyonghu',
                                    text: "<span class='menu_text' >服务用户管理</span>",
                                    leaf: true,
                                    href: 'javascript:toLoadurl(\'serviceUser/index.shtml\',\'serviceUser_main\',\'服务用户管理\')'
                                },
                                {
                                    id: "02",
                                    iconCls: 'icon_fuwushouquanguanli',
                                    text: "<span class='menu_text' >服务授权管理</span>",
                                    leaf: true,
                                    href: 'javascript:toLoadurl(\'serviceAuth/index.shtml\',\'serviceAuth_main\',\'服务授权管理\')'
                                }
                            ]
                        }
                    }
                            ...
                            root: {
                                ...
                                children: [

                                    {
                                        ...
                                        text: "<span class='menu_text' ><%=Messages.getString("Default.Jsp.Menu.System.Mail") %></span>",
                                        leaf: true,
                                        href: 'javascript:toLoadurl(\'mail?action=manage\',\'mail_main\',\'<%=Messages.getString("Default.Jsp.Menu.System.Mail") %>\');'
                                    },
                                    {
                                        iconCls: 'icon_yonghuguanli',
                                        text: "<span class='menu_text' ><%=Messages.getString("Default.Jsp.Menu.System.User") %></span>",
                                        leaf: true,
...
<div id="container">
    <div id="north">
        <table style="width:100%;" cellpadding="2" cellspacing="0" border="0" height="48px"
               background="images/index_north_bg.jpg">
            <tbody>
            <tr>
