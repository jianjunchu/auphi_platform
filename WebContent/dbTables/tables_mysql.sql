...
CREATE TABLE `T_SERVICE_AUTH` (
  ...
  `LINES_LIMIT` bigint(20) DEFAULT NULL COMMENT '限制条数',
  `CYCLE_LIMIT` int(11) DEFAULT NULL COMMENT '限制周期 1:分钟 2:小时 3:天 4:月 5:年',
  `TIME_LIMIT` int(11) DEFAULT NULL COMMENT '限制时间',
  PRIMARY KEY  (`AUTH_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `T_SERVICE_MONITOR` (
  ...
  `LINES_OUTPUT` bigint(20) DEFAULT NULL COMMENT '输出记录数',
  PRIMARY KEY  (`MONITOR_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `METADATA_MAPPING` (
  ...
  `MAPPING_GROUP_ID` bigint(64) NOT NULL COMMENT '映射分组ID',
  `SOURCE_DB_ID` bigint(20) NOT NULL COMMENT '源数据库ID',
  `SOURCE_SCHEMA_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源模式名',
  `SOURCE_TABLE_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源表名',
  `SOURCE_COLUMN_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源列名',
  `SOURCE_COLUMN_TYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源列数据类型',
  `SOURCE_COLUMN_TYPE_ETL` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源列在Kettle 中的数据类型 (String,Date,BigNumber,Integer)',
  `SOURCE_COLUMN_LENGTH` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '长度或精度',
  `SOURCE_COLUMN_SCALE` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '刻度',
  `SOURCE_COLUMN_COMMENTS` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '源列注释',
  `SOURCE_COLUMN_ORDER` bigint(20) DEFAULT NULL COMMENT '源列顺序',
  `IS_PK` int(11) DEFAULT NULL COMMENT '是否主键 ， 0不是，1是主键',
  `IS_INCREMENTAL_COLUMN` int(11) NOT NULL DEFAULT 0 COMMENT '是否增量字段1:是 0:否',
  `DEST_DB_ID` bigint(20) NOT NULL COMMENT '目的数据库ID',
  `DEST_SCHEMA_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的模式名',
  `DEST_TABLE_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的表名',
  `DEST_COLUMN_NAME` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的列名',
  `DEST_COLUMN_TYPE` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的列类型',
  `DEST_COLUMN_TYPE_ETL` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的列Kettle 数据类型',
  `DEST_COLUMN_LENGTH` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的列长度或精度',
  `DEST_COLUMN_SCALE` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT '目的列刻度',
  `EXTRACT_STYLE` int(11) NOT NULL DEFAULT 0 COMMENT '抽取方式，0全量，1增量 ， 默认0',
  `EXTRACT_STATUS` int(11) NOT NULL DEFAULT 0 COMMENT '抽取状态，0未抽取，1正在抽取  默认0',
  `LAST_EXTRACT_START_TIME` datetime DEFAULT NULL,
  `EXTRACT_START_TIME` datetime DEFAULT NULL,
  `LAST_EXTRACT_END_TIME` datetime DEFAULT NULL,
  `CREATE_TIME` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CREATE_USER` int(11) NOT NULL,
  `UPDATE_TIME` datetime DEFAULT NULL DEFAULT CURRENT_TIMESTAMP,
  `UPDATE_USER` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `METADATA_MAPPING_GROUP`;
CREATE TABLE `METADATA_MAPPING_GROUP` (
  `ID` bigint(64) NOT NULL,
  `MAPPING_GROUP_NAME` varchar(255) DEFAULT NULL COMMENT '映射组名称',
  `MAPPING_GROUP_DESC` varchar(255) DEFAULT NULL COMMENT '映射组描述',
  `CREATE_TIME` datetime DEFAULT NULL,
