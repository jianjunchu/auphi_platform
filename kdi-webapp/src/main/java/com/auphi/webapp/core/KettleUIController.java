...
import com.auphi.designer.utils.SvgImageUrl;
import com.auphi.webapp.utils.StepImageManager;
...
public class KettleUIController {
	...
	@ResponseBody
	@RequestMapping(method={RequestMethod.POST, RequestMethod.GET}, value="/lang")
	protected void lang(HttpServletRequest request, HttpServletResponse response, @PathVariable String pluginId) throws Exception {
		...
		try {
			InputStream inStr = ClassLoader.getSystemResourceAsStream("org.pentaho.di.trans.steps.textfileinput.messages.messages");
