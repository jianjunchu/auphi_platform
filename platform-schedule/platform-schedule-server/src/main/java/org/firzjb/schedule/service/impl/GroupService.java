...
import org.firzjb.schedule.i18n.Messages;
import org.firzjb.schedule.mapper.GroupMapper;
...
public class GroupService extends BaseService<GroupMapper, Group> implements IGroupService {
    ...
    @Override
    public GroupResponse getDefaultGroup(Long organizerId, Long unitId) {
