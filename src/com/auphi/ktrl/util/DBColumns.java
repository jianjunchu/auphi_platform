...
{
    public static String TABLE_USER = "KDI_T_USER" ;
    public static String TABLE_ROLE = "KDI_T_ROLE" ;
    public static String TABLE_USER_ROLE = "KDI_T_USER_ROLE" ;
    ...
    public static String COLUMN_USER_NICKNAME = "C_NICK_NAME" ;
    public static String COLUMN_USER_EMAIL = "C_EMAIL" ;
    public static String COLUMN_USER_MOBILEPHONE = "C_MOBILEPHONE" ;
    public static String COLUMN_USER_DESCRIPTION = "C_DESCRIPTION" ;
    ...
    public static String COLUMN_REP_PASSWORD = "C_PASSWORD" ;
    public static String COLUMN_REP_VERSION = "C_VERSION" ;
    public static String COLUMN_REP_DBHOST = "C_DB_HOST" ;
    public static String COLUMN_REP_DBPORT = "C_DB_PORT" ;
    public static String COLUMN_REP_DBNAME = "C_DB_NAME" ;
    ...
    public static String COLUMN_ORG_EMAIL = "ORGANIZER_EMAIL" ;
    public static String COLUMN_ORG_PASSWD = "ORGANIZER_PASSWD" ;
    public static String COLUMN_ORG_TELPHONE = "ORGANIZER_TELPHONE" ;
    public static String COLUMN_ORG_MOBILE = "ORGANIZER_MOBILE" ;
