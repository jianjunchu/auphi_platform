...
//			response.getWriter().close();
			...
			systemLog.setUsername(userBean.getUser_name());
			systemLog.setModule("ScheduleController");
			systemLog.setOperation("修改调度:"+checked_job);
			...
			systemLog.setUsername(userBean.getUser_name());
			systemLog.setModule("ScheduleController");
			systemLog.setOperation("删除调度:"+checked_job);
			...
			systemLog.setUsername(userBean.getUser_name());
			systemLog.setModule("ScheduleController");
			systemLog.setOperation("暂停调度:"+checked_job);
			...
			systemLog.setUsername(userBean.getUser_name());
			systemLog.setModule("ScheduleController");
			systemLog.setOperation("恢复调度:"+checked_job);
			...
			systemLog.setUsername(userBean.getUser_name());
			systemLog.setModule("ScheduleController");
			systemLog.setOperation("执行调度:"+checked_job);
