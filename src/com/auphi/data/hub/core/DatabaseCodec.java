...
import com.auphi.data.hub.core.util.JSONArray;
import com.auphi.data.hub.core.util.JSONObject;
...
public class DatabaseCodec {
    ...
    public static DatabaseMeta decode(JSONObject jsonObject) throws KettleDatabaseException {
        ...
        databaseMeta.setName(databaseMeta.getName());
